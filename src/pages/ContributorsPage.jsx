...
const ContributorsPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const contributorsResponse = await fetch('https://api.github.com/repos/saurabhbakolia/SCROLLME--ECOMMERCE-WEBSITE/contributors?per_page=100');
        const contributorsData = await contributorsResponse.json();
        setContributors(contributorsData);

        const repoResponse = await fetch('https://api.github.com/repos/saurabhbakolia/SCROLLME--ECOMMERCE-WEBSITE');
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="relative flex items-center justify-center text-center bg-gradient-to-r from-teal-600 to-teal-800" style={{ height: "90vh" }}>
          ...
          <div className="relative z-10 max-w-4xl px-4 mx-auto space-y-6">
            ...
            <motion.p 
              className="text-xl text-teal-200 sm:text-2xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <a 
                href="#contribute" 
                className="inline-block px-8 py-4 mt-8 font-bold text-teal-600 transition duration-300 ease-in-out bg-white rounded-full shadow-lg hover:bg-teal-100"
              >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              <StatCard 
                ...
                icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-teal-500" viewBox="0 0 20 20" fill="currentColor">
        ...
        {/* Call to Action */}
        <section id="contribute" className="px-4 py-16 text-white bg-teal-600  sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center space-y-4">
              ...
              <button
                type="submit"
                className="inline-block px-8 py-4 font-bold text-teal-600 transition duration-300 ease-in-out bg-white rounded-full shadow-lg hover:bg-teal-100"
              >
                Submit Email
              </button>
            </form>
